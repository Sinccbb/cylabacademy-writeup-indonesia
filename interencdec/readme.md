...
Perlu kita perhatikan, bahwa hasil decoder belum jelas, namun ada sebuah tanda, yaitu ```==``` pada akhir string. Yang menandakan itu adalah Encoded Base64hanya saja 
